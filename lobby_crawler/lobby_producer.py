...
class LobbyProducer:
    def __init__(self):
        ...
        protobuf_serializer = ProtobufSerializer(
            lobby_pb2.Lobby, schema_registry_client, {"use.deprecated.format": True}
        )
    ...
    def produce_to_topic(self, lobby: Lobby):
        self.producer.produce(
            topic=TOPIC, partition=-1, key=str(lobby.id), value=lobby, on_delivery=self.delivery_report
        )
